...
function EditQuotePage() {
    ...
    const [customerNameSnapshot, setCustomerNameSnapshot] =
        useState<string>("");
    const [warehouseId, setWarehouseId] = useState<string>("");
    const [issueDate, setIssueDate] = useState<string>("");
    const [validUntil, setValidUntil] = useState<string>("");
    const [discountType, setDiscountType] =
        useState<QuoteDiscountType>("none");
    ...
    useEffect(() => {
        ...
        setCustomerNameSnapshot(quote.customer_name_snapshot ?? "");
        setWarehouseId(quote.warehouse.id);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            router.push(
                `/organisation/${orgId}/inventory/quotes/${quoteId}`
            );
        } catch (err) {
            ...
            <div className="container mx-auto p-6">
                <Card>
                    <CardContent className="pt-6 space-y-3">
                        <p className="text-sm">
                            Ce devis ne peut plus être modifié (statut :{" "}
    ...
    return (
        <FormPageLayout
            ...
            subtitle="Modifiez le brouillon avant de l'envoyer ou de le convertir en vente."
            backLink={`/organisation/${orgId}/inventory/quotes/${quoteId}`}
            sidebar={
                <Card>
                    <CardHeader>
